                    ...
                    <div class="card-header">
                        <div class="row" style="padding-left: 15px; padding-right: 15px;">
                            ...
                            <div style="display:table; text-align: center;">
                                <h4 class="text-primary" style="display:table-cell; vertical-align:middle;">
                                    Profesionales
                                    Internacionales</h4>
                            </div>
                        </div>
                        ...
                        <form action="{{ url('empresa/store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <input name="correo_empresa" class="form-control" type="email"
                                        placeholder="Email..." required>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <label class="text-info">¿A través de qué medio se entero de AIESEC? *:
                                    </label>
